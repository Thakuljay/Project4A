...
public class BackgroundWorkerTransferscan extends AsyncTask<String, Void, String> {
    Context context;
    AlertDialog.Builder builder;
    public static String test;
    private ArrayList<String> exData;
    private ProgressDialog progressDialog;
    public BackgroundWorkerTransferscan(Context ctx) {
        context = ctx;
    }
